        ...
        <div class="col-12 col-md-12 col-lg-11 col-xl-11">
            <div class="card">
                <div class="card-header bg-dark d-flex flex-row justify-content-between">
                    <a href="index.php?pid=<?php echo base64_encode("Vista/Despachador/crearDespachador.php") ?>"><button type="button" class="btn btn-outline-light">Crear nuevo</button></a>
...
<script type="text/javascript">
    $(function() {
        ...
        $.post("indexAJAX.php?pid=<?php echo base64_encode("Vista/Despachador/Ajax/searchBarDespachador.php") ?>", json, function(data) {
            console.log(data);
            res = JSON.parse(data);
    ...
    $(function() {
        ...
        $("#tabla").on('click', ".moreInfoBtn", function() {
            $url = "indexAJAX.php?pid=<?php echo base64_encode("Vista/Despachador/Ajax/moreInfoDespachador.php") ?>&idDespachador=" + $(this).data("iddespachador");
            $(".modal-body").load($url);
        });
        ...
        $('.table').on('change', '.select-estado', function() {
            json = {
                "idDespachador": $(this).data('id'),
                "estado": $(this).val(),
            };
            $.post("indexAJAX.php?pid=<?php echo base64_encode("Vista/Despachador/Ajax/updateEstadoDespachador.php") ?>", json, function(data) {
                console.log(data);
                res = JSON.parse(data);
            ...
            $("#tabla").append(
                `<tr>
                    ...
                    <td style='display:flex; justify-content:center;'>
                        <a href='index.php?pid=${DataL}&idDespachador=${data[0]}'>
                            <i class='far fa-edit'></i>
                        </a>
                        <a href='#' class="moreInfoBtn" data-iddespachador="${data[0]}" data-toggle="modal" data-target="#moreInfo"><i class='fas fa-info-circle'></i></a>
                    </td>
                </tr>`
            );
        });
