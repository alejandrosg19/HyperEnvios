    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Información cita</h5>
...
<script type="text/javascript">
    $(function() {
        ...
        $.post("indexAJAX.php?pid=<?php echo base64_encode("Vista/Cita/Ajax/searchBarCita.php") ?>", json, function(data) {
            console.log(data);
            res = JSON.parse(data);
    ...
    $(function() {
        ...
        $("#tabla").on('click', ".moreInfoBtn", function() {
            $url = "indexAJAX.php?pid=<?php echo base64_encode("Vista/Cita/Ajax/moreInfoCita.php") ?>&idCita=" + $(this).data("idcita");
            $(".modal-body").load($url);
        });
            ...
            $("#tabla").append(
                `<tr>
                    ...
                    <td style='display:flex; justify-content:center;'>
                        <a href='#' class="moreInfoBtn" data-idcita="${data[0]}" data-toggle="modal" data-target="#moreInfo">
