        ...
        <div class="col-12 col-md-12 col-lg-11 col-xl-11">
            <div class="card">
                <div class="card-header bg-dark d-flex flex-row justify-content-between">
                    <a href="index.php?pid=<?php echo base64_encode("Vista/Administrador/crearAdministrador.php") ?>"><button type="button" class="btn btn-outline-light">Crear Administrador</button></a>
...
<script type="text/javascript">
    $(function() {
        ...
        $.post("indexAJAX.php?pid=<?php echo base64_encode("Vista/Administrador/Ajax/searchBarAdministrador.php") ?>", json, function(data) {
            console.log(data);
            res = JSON.parse(data);
    ...
    $(function() {
        ...
        $("#tabla").on('click', ".moreInfoBtn", function() {
            $url = "indexAJAX.php?pid=<?php echo base64_encode("Vista/Administrador/Ajax/moreInfoAdministrador.php") ?>&idAdministrador=" + $(this).data("idadministrador");
            $(".modal-body").load($url);
        });
            ...
            $("#tabla").append(
                `<tr>
                    ...
                    <td style='display:flex; justify-content:center;'>
                        <a href='#' class="moreInfoBtn" data-idadministrador="${data[0]}" data-toggle="modal" data-target="#moreInfo"><i class='fas fa-info-circle'></i></a>
                    </td>
                </tr>`
            );
        });
