...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#tabla").on('click', ".moreInfoBtn", function() {
            $url = "indexAJAX.php?pid=<?php echo base64_encode("Vista/Cliente/Ajax/moreInfoCliente.php") ?>&idLog=" + $(this).data("id") + "&idTable=" + $(this).data("table");
            $(".modal-body").load($url);
        });
            ...
            $("#tabla").append(
                `<tr>
                    ...
                    <td style='display:flex; justify-content:center;'>
                        ...
                        <a href='#' class="moreInfoBtn" data-id="" data-table="" data-toggle="modal" data-target="#moreInfo"><i class='fas fa-info-circle'></i></a>
                    </td>
                </tr>`
            );
        });
